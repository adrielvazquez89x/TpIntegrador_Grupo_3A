<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Seasons.aspx.cs" Inherits="TpIntegrador_Grupo_3A.Admin.Seasons" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="container my-4">
                <%-- Título de la página --%>
                <h2 class="text-center mb-4">Gestión de Temporadas</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header bg-success text-white">
                                <h3 class="card-title mb-0">Temporadas</h3>
                            </div>
                            <div class="card-body">
                                <asp:Label ID="lblSeason" runat="server" Text="Temporada" CssClass="form-label"></asp:Label>
                                <asp:TextBox ID="txtSeason" runat="server" CssClass="form-control mb-3"></asp:TextBox>
                                <asp:Button
                                    ID="btnAddSeason"
                                    runat="server"
                                    Text="Agregar"
                    ...
                    <div class="col-md-8">
                        <asp:GridView
                            ...
                            OnPageIndexChanging="dgvSeasons_PageIndexChanging"
                            AllowPaging="true"
                            PageSize="5">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Acciones">
                                    <ItemTemplate>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <%-- Botón Activar --%>
                                            <asp:LinkButton
                                                ID="btnActivateSeason"
                                                runat="server"
                                                CssClass="btn btn-sm btn-outline-success"
                                                OnClick="btnActivateSeason_Click"
                                                CommandArgument='<%# Eval("Id") + "|" + Eval("Description")+ "|" + Eval("Active") %>'
                                                Visible='<%# !Convert.ToBoolean(Eval("Active")) %>'
                                                ToolTip="Activar">
